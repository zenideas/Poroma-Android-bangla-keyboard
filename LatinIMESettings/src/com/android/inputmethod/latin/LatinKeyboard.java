...
public class LatinKeyboard extends Keyboard {
    ...
    /**
     * keyboard এর theme অনুযায়ী button এর icon and key label change করে।  
     * @param isAutoCompletion
     * @param isBlack
     */
    ...
    public static BanglaRenderer bRender = new BanglaRenderer();
...
//        String language = LanguageSwitcher.toTitleCase(locale.getDisplayLanguage(locale));
        ...
        String language;
        if((locale.toString()).equals("ph")) {
    		language = BanglaRenderer.convert("ফোনেটিক");
    	} else if((locale.toString()).equals("bn")) {
    		language = BanglaRenderer.convert("প্রজন্ম");
    	} else
    		language = LanguageSwitcher.toTitleCase(locale.getDisplayLanguage(locale));
    ...
    /**
     * Language switcher show করে। selected language ১ এর বেশি হলে show করে, কম হলে show করেনা।   
     * @param switcher
     * @param isAutoCompletion
     * @param isBlackSym
     */
...
//                                        Log.d(TAG, "CORRECTED ALTHOUGH PREFERRED !!!!!!");
    ...
    class SlidingLocaleDrawable extends Drawable {
        ...
        private String getLanguageName(Locale locale) {
        	if((locale.toString()).equals("ph")) {
        		return BanglaRenderer.convert("ফোনেটিক");
        	} else if((locale.toString()).equals("bn")) {
        		return BanglaRenderer.convert("প্রজন্ম");
        	} else
